...
What this suite does **not** establish. A conformance report is only useful if the reader knows what it was never checking, so this is the companion to the report rather than a footnote to it.
